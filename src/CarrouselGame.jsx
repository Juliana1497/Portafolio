    ...
    const slides = items.map((item) => {
      return (
        ...
        >
          ...
          <a target="_blank" rel="noopener noreferrer" href={item.github}><CarouselCaption captionText={item.captions} captionHeader={item.caption} className="carrousel-1 shadow p-3 mb-5 bg-body-tertiary rounded"/></a>
        </CarouselItem>
      );
    });
